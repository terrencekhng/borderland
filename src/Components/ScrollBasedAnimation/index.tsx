...
const ScrollBasedAnimation = () => {
  useEffect(() => {
    ...
    const canvas = document.getElementById('scroll-animation') as HTMLCanvasElement;
    ...
    const tick = () => {
      ...
      particles.rotation.x += (parallaxY - particles.rotation.x) * deltaTime * 3;
  ...
  return (
    <>
      ...
      <canvas id='scroll-animation' className={styles['scroll-animation']}></canvas>
    </>
  )
}
